...
public class CountDownProgressBar extends View {
     ...
     * 中间文字的字体大小(默认40dp)
     */
    private int centerTextSize=(int) dip2px(40);

    /**
     * 圆环的宽度
     */
    private int circleWidth=(int) dip2px(6f);
        ...
        for (int i = 0; i < n; i++) {
            ...
            switch (attr) {
                ...
                case R.styleable.CountDownProgressBar_countDown_secondColor:
                    secondColor = ta.getColor(attr, Color.WHITE); // 默认进度条颜色为白色
                    break;
                ...
                case R.styleable.CountDownProgressBar_countDown_centerTextColor:
                    centerTextColor = ta.getColor(attr, Color.WHITE); // 默认中间文字颜色为白色
                    break;
